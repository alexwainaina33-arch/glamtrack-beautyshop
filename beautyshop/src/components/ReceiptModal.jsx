    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal" style={{ maxWidth: 480 }}>
        ...
        <div className="modal-body">
          ...
          {/* Digital receipt status. KRA/eTIMS is shown only after a real verified integration exists. */}
          <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, padding: '10px 14px', marginBottom: 16, fontSize: 13 }}>
            <span style={{ color: '#475569', fontWeight: 700 }}>🧾 SalesTrack Digital Receipt</span>
          </div>
          ...
          <div ref={receiptRef} id="receipt-print" style={{ fontFamily: 'monospace', fontSize: 13, lineHeight: 1.6, background: '#fff', padding: 20, borderRadius: 10, border: '1px dashed #f0e4e8' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 12 }}>
              ...
              <div style={{ marginTop: 8, borderTop: '1px dashed #ccc', paddingTop: 8, fontSize: 11 }}>
                <div style={{ fontWeight: 700 }}>DIGITAL SALES RECEIPT</div>
            ...
            <div style={{ textAlign: 'center', marginTop: 16, paddingTop: 10, borderTop: '1px dashed #ccc', fontSize: 10, color: '#6b7280' }}>
              <div>This receipt was electronically generated by SalesTrack.</div>
