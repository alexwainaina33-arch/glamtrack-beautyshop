  ...
  monthly: [
    {
      ...
      features: [
        '1 admin + 1 cashier account',
        'POS — sell online & offline',
        'Inventory & stock tracking',
        'Digital receipts via WhatsApp',
        'Free public shop website',
      ...
      missing: ['AI business insights', 'Staff commissions', 'Appointments & bookings', 'Multi-branch'],
    },
    {
